 ...
 */
export const API_VERSION = 24; // 24: + fork.plan hook + fsWrite capability; 23: + env defaults (SpawnPlanOutput.envDefaults); 22: + staged shared skills (SpawnPlanInput.skills)

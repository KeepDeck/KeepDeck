...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            project_fs::read::project_fs_read_dir,
            project_fs::read::project_fs_read_file,
            project_fs::watch::project_fs_watch,
            project_fs::watch::project_fs_unwatch,

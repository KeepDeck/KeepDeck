...
/// Menu item id for "File → New Workspace…" (⌘N).
const NEW_WORKSPACE_ID: &str = "new-workspace";
/// Webview event for [`NEW_WORKSPACE_ID`]; mirrored in `src/ipc/menu.ts`.
pub const NEW_WORKSPACE_EVENT: &str = "deck://menu/new-workspace";
...
pub fn build<R: Runtime>(app: &AppHandle<R>) -> tauri::Result<Menu<R>> {
    let new_workspace = MenuItemBuilder::with_id(NEW_WORKSPACE_ID, "New Workspace…")

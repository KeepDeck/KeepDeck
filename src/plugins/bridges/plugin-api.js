...
//
// UNLIKE react.js / react-jsx-runtime.js / react-dom.js /
// react-dom-client.js, this one is a plain `export *`: those bridges hand-list
// names because React's packages are CJS underneath, and Rollup's CJS→ESM
// interop cannot statically discover named exports on a `module.exports`
// object assigned at runtime (verified: `export *` over that interop yields
// zero bindings).

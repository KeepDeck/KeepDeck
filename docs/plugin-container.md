...
| `logic.js`       | no       | Self-contained ESM bundle run in the plugin's logic realm (hooks, storage, events over RPC). No externals — bundle everything, including `@keepdeck/plugin-guest`. |
